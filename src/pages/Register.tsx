...
const Register: React.FC = () => {
  ...
  const onRegister = async (data: RegisterFormData) => {
    ...
    try {
      ...
      const isOtpValid = true; // In a real app, this would come from the API response
      ...
      setRegisterError('An error occurred during verification.');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">Join RedCap for seamless logistics solutions</p>
        </div>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-lg sm:rounded-lg sm:px-10">
          <form className="space-y-6">
            ...
            <div className={`${otpSent ? 'pointer-events-none opacity-50' : ''}`}>
              <div>
